...
const ServiceAssignmentDashboard = ({ stats, activeAgentsCount }: ServiceAssignmentDashboardProps) => {
  return (
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{activeAgentsCount}</p>
            </div>
